...
export function SupportButton() {
  ...
  const handleSupportClick = () => {
    window.open(buildWhatsAppSupportUrl('dashboard'), '_blank', 'noopener,noreferrer');
  };
    ...
    <div className="fixed bottom-6 right-6 z-40">
      ...
      >
        ...
        >
          ...
          />
          <span
            className={`whitespace-nowrap font-bold text-lg transition-all duration-300 overflow-hidden ${

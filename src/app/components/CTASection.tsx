    ...
    <section className={`relative py-32 overflow-hidden transition-colors duration-300 ${
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {theme === 'dark' ? (
          ...
          <>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] rounded-full blur-[220px] bg-[#1A1FE8]/11" />
            <div className="absolute top-0 left-0 w-[400px] h-[300px] rounded-full blur-[160px] bg-[#1A1FE8]/7" />
            <div className="absolute bottom-0 right-0 w-[400px] h-[300px] rounded-full blur-[160px] bg-[#3D42F0]/7" />
          </>
        )}
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h2 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
            <span className={theme === 'dark' ? 'text-white' : 'text-gray-900'}>¿Listo para </span>
            <span
              style={{
                color: '#1A1FE8',
                textShadow: theme === 'dark' ? '0 0 60px rgba(26,31,232,0.6)' : '0 0 30px rgba(26,31,232,0.15)',
              }}
            >
              Yours Tomorrow
            </span>
          ...
          <p className={`text-xl mb-12 leading-relaxed ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>
            Únete a más de{' '}
            <span className="text-[#1A1FE8] font-bold">100 conductores</span>{' '}
            que ya están construyendo su patrimonio mientras trabajan
          </p>

          <div className="flex flex-col sm:flex-row gap-5 justify-center mb-16">
            <button className="group relative px-10 py-4 bg-[#1A1FE8] text-white rounded-2xl font-bold text-base overflow-hidden transition-all duration-300 shadow-[0_0_50px_rgba(26,31,232,0.45)] hover:shadow-[0_0_70px_rgba(26,31,232,0.65)]">
          ...
          <div className="grid md:grid-cols-2 gap-5 max-w-2xl mx-auto mb-12">
            {[
              ...
              <div key={label} className="group relative">
                <div className="absolute inset-0 bg-[#1A1FE8]/15 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
                <div className={`relative flex items-center gap-4 rounded-2xl p-5 border transition-all ${
                  ...
                  <div className="w-12 h-12 bg-[#1A1FE8] rounded-xl flex items-center justify-center flex-shrink-0 shadow-[0_0_20px_rgba(26,31,232,0.4)]">
                    <Icon className="w-5 h-5 text-white" />
                  </div>
                  <div className="text-left">
                    <div className={`text-xs font-medium mb-0.5 ${theme === 'dark' ? 'text-[#6B70F5]' : 'text-[#1A1FE8]'}`}>{label}</div>
          ...
          {/* Trust indicators */}
          <div className={`flex flex-wrap justify-center gap-8 text-sm ${theme === 'dark' ? 'text-gray-500' : 'text-gray-400'}`}>
